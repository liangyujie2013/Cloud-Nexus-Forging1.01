...
export const mockData = {
  ...
  hosts: [
    { id: 1, cluster_id: 1, datacenter_id: 1, name: 'node-prod-01', hostname: 'node-prod-01', ip: '192.168.1.100', ssh_port: 22, ssh_user: 'root', netmask: '255.255.255.0', gateway: '192.168.1.1', mgmt_vlan: 10, mgmt_nic: 'bond0', status: 'connected', maintenance_mode: false, cpu_model: 'Intel Xeon Gold 6248R', cpu_vendor: 'intel', cpu_microarch: 'Cascade Lake', cpu_gen: 2, cpu_baseline: 'Cascade-Server-noTSX', sockets: 2, cores: 24, threads: 2, vcpus: 96, numa_nodes: 2, mem_total_gb: 512, mem_used_gb: 318, cpu_usage: 62, mem_usage: 62, vms: 2, gpus: 0, iommu: true, nic_model: 'Intel X710-DA2 (2×10GbE)', raid_model: 'Broadcom MegaRAID 9560-8i', disk_model: 'Samsung PM9A3 1.92TB NVMe', sriov_pfs: [], last_heartbeat: '2026-06-24T09:30:00Z', created_at: '2026-01-16T09:00:00Z' },
    { id: 2, cluster_id: 1, datacenter_id: 1, name: 'node-prod-02', hostname: 'node-prod-02', ip: '192.168.1.101', ssh_port: 22, ssh_user: 'root', netmask: '255.255.255.0', gateway: '192.168.1.1', mgmt_vlan: 10, mgmt_nic: 'bond0', status: 'connected', maintenance_mode: false, cpu_model: 'Intel Xeon Gold 6248R', cpu_vendor: 'intel', cpu_microarch: 'Cascade Lake', cpu_gen: 2, cpu_baseline: 'Cascade-Server-noTSX', sockets: 2, cores: 24, threads: 2, vcpus: 96, numa_nodes: 2, mem_total_gb: 512, mem_used_gb: 276, cpu_usage: 48, mem_usage: 54, vms: 2, gpus: 0, iommu: true, nic_model: 'Intel X710-DA2 (2×10GbE)', raid_model: 'Broadcom MegaRAID 9560-8i', disk_model: 'Samsung PM9A3 1.92TB NVMe', sriov_pfs: [], last_heartbeat: '2026-06-24T09:30:00Z', created_at: '2026-01-16T09:30:00Z' },
    { id: 3, cluster_id: 1, datacenter_id: 1, name: 'node-prod-03', hostname: 'node-prod-03', ip: '192.168.1.102', ssh_port: 22, ssh_user: 'root', netmask: '255.255.255.0', gateway: '192.168.1.1', mgmt_vlan: 10, mgmt_nic: 'bond0', status: 'connected', maintenance_mode: false, cpu_model: 'Intel Xeon Platinum 8380', cpu_vendor: 'intel', cpu_microarch: 'Ice Lake', cpu_gen: 3, cpu_baseline: 'Icelake-Server', sockets: 2, cores: 24, threads: 2, vcpus: 96, numa_nodes: 2, mem_total_gb: 512, mem_used_gb: 401, cpu_usage: 78, mem_usage: 78, vms: 1, gpus: 0, iommu: true, nic_model: 'Intel X710-DA2 (2×10GbE)', raid_model: 'Broadcom MegaRAID 9560-8i', disk_model: 'Samsung PM9A3 1.92TB NVMe', sriov_pfs: [], last_heartbeat: '2026-06-24T09:30:00Z', created_at: '2026-01-16T10:00:00Z' },
    { id: 4, cluster_id: 1, datacenter_id: 1, name: 'node-prod-04', hostname: 'node-prod-04', ip: '192.168.1.103', ssh_port: 22, ssh_user: 'root', netmask: '255.255.255.0', gateway: '192.168.1.1', mgmt_vlan: 10, mgmt_nic: 'bond0', status: 'maintenance', maintenance_mode: true, cpu_model: 'AMD EPYC 7763', cpu_vendor: 'amd', cpu_microarch: 'Milan (Zen3)', cpu_gen: 3, cpu_baseline: 'EPYC-Milan', sockets: 2, cores: 24, threads: 2, vcpus: 96, numa_nodes: 2, mem_total_gb: 512, mem_used_gb: 0, cpu_usage: 0, mem_usage: 0, vms: 0, gpus: 0, iommu: true, nic_model: 'Intel X710-DA2 (2×10GbE)', raid_model: 'Broadcom MegaRAID 9560-8i', disk_model: 'Samsung PM9A3 1.92TB NVMe', sriov_pfs: [], last_heartbeat: '2026-06-24T08:10:00Z', created_at: '2026-01-16T10:30:00Z' },
    { id: 5, cluster_id: 2, datacenter_id: 1, name: 'gpu-node-01', hostname: 'gpu-node-01', ip: '192.168.2.110', ssh_port: 22, ssh_user: 'root', netmask: '255.255.255.0', gateway: '192.168.2.1', mgmt_vlan: 20, mgmt_nic: 'bond0', status: 'connected', maintenance_mode: false, cpu_model: 'Intel Xeon Platinum 8358', cpu_vendor: 'intel', cpu_microarch: 'Ice Lake', cpu_gen: 3, cpu_baseline: 'Icelake-Server', sockets: 2, cores: 32, threads: 2, vcpus: 128, numa_nodes: 2, mem_total_gb: 1024, mem_used_gb: 612, cpu_usage: 55, mem_usage: 60, vms: 2, gpus: 4, iommu: true, nic_model: 'Mellanox ConnectX-6 Dx (2×100GbE)', raid_model: 'Broadcom MegaRAID 9560-16i', disk_model: 'Intel D7-P5520 3.84TB NVMe', sriov_pfs: [{ pf: 'ens6f0', nic_model: 'Mellanox ConnectX-6 Dx', total_vfs: 16, used_vfs: 2, link_gbe: 100, vfs: [{ vf: 0, used: true, vm: 'ai-training-01' }, { vf: 1, used: true, vm: 'ai-inference-01' }, { vf: 2, used: false }, { vf: 3, used: false }, { vf: 4, used: false }, { vf: 5, used: false }, { vf: 6, used: false }, { vf: 7, used: false }] }], last_heartbeat: '2026-06-24T09:30:00Z', created_at: '2026-01-18T09:00:00Z' },
    { id: 6, cluster_id: 2, datacenter_id: 1, name: 'gpu-node-02', hostname: 'gpu-node-02', ip: '192.168.2.111', ssh_port: 22, ssh_user: 'root', netmask: '255.255.255.0', gateway: '192.168.2.1', mgmt_vlan: 20, mgmt_nic: 'bond0', status: 'connected', maintenance_mode: false, cpu_model: 'Intel Xeon Platinum 8462Y+', cpu_vendor: 'intel', cpu_microarch: 'Sapphire Rapids', cpu_gen: 4, cpu_baseline: 'SapphireRapids', sockets: 2, cores: 32, threads: 2, vcpus: 128, numa_nodes: 2, mem_total_gb: 1024, mem_used_gb: 720, cpu_usage: 71, mem_usage: 70, vms: 1, gpus: 4, iommu: true, nic_model: 'Mellanox ConnectX-6 Dx (2×100GbE)', raid_model: 'Broadcom MegaRAID 9560-16i', disk_model: 'Intel D7-P5520 3.84TB NVMe', sriov_pfs: [{ pf: 'ens6f0', nic_model: 'Mellanox ConnectX-6 Dx', total_vfs: 16, used_vfs: 0, link_gbe: 100, vfs: [{ vf: 0, used: false }, { vf: 1, used: false }, { vf: 2, used: false }, { vf: 3, used: false }] }], last_heartbeat: '2026-06-24T09:30:00Z', created_at: '2026-01-18T09:30:00Z' },
  ],
...
export function getHostHardware(id: number) {
  ...
  return {
    ...
    iommu_summary, gpus,
    // N5 · SR-IOV 物理网卡（PF）及其 VF 分配状态
    sriov_pfs: (host as any).sriov_pfs || [],
